        ...
        <section className='max-w-7xl mx-auto'>
            <div className='font-extrabold text-[#222328] text-[32px]'>
                ...
                <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>
                    Create imaginative and visually stunning images through Dale AI and share them with the community
                </p>
            </div>
            ...
            <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
                <div className='flex flex-col gap-5'>
                    ...
                    <FormField
                        ...
                        type='text'
                        name='prompt'
                        placeholder='panda mad scientist mixing sparkling chemicals, digital arte'
                        value={form.prompt}
                        handleChange={handleChange}
                        isSurpriseMe
